...
void Model::loadColors(_In_ const aiMaterial* pMaterial, _In_ UINT uIndex)
{
	...
	{
		m_aMaterials
			[uIndex].AmbientColor.x = ambientColor.r;
		m_aMaterials
			[uIndex].AmbientColor.y = ambientColor.g;
		m_aMaterials
			[uIndex].AmbientColor.z = ambientColor.b;
	}
	aiColor3D diffuseColor(0.0f, 0.0f, 0.0f);
	if (pMaterial->Get(AI_MATKEY_COLOR_DIFFUSE, diffuseColor) == AI_SUCCESS)
	{
		m_aMaterials
			[uIndex].DiffuseColor.x = diffuseColor.r;
		m_aMaterials
			[uIndex].DiffuseColor.y = diffuseColor.g;
		m_aMaterials
			[uIndex].DiffuseColor.z = diffuseColor.b;
	}
	aiColor3D specularColor(0.0f, 0.0f, 0.0f);
	if (pMaterial->Get(AI_MATKEY_COLOR_SPECULAR, specularColor) == AI_SUCCESS)
	{
		m_aMaterials
			[uIndex].SpecularColor.x = specularColor.r;
		m_aMaterials
			[uIndex].SpecularColor.y = specularColor.g;
		m_aMaterials
			[uIndex].SpecularColor.z = specularColor.b;
	}
}
